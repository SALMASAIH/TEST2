        ...
        <main className="app-content">
          <div className="app-title">
            ...
            <ul className="app-breadcrumb breadcrumb side">
              ...
              <li className="breadcrumb-item active"><NavLink to="/etudiants">Etudiants</NavLink></li>
            </ul>
          </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="tile">
                <h3 className="tile-title">Ajouter un nouveau étudiant</h3>
                <div className="tile-body">
                  ...
                  <form onSubmit={handleSave}>
                    ...
                    <div class="tile-footer">
                      <button class="btn btn-primary" type="submit"><i class="bi bi-check-circle-fill me-2"></i>Enregistrer</button>&nbsp;&nbsp;&nbsp;<NavLink className="btn btn-secondary" to="/Etudiants"><i class="bi bi-x-circle-fill me-2"></i>Annuler</NavLink>
                    </div>
                  </form>
                </div>
              </div>
